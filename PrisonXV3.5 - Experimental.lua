...
b = w7:Toggle("Enable Minimilist Mode", {flag = "modechange"}, function()
if w7.flags.modechange then
game.CoreGui.ScreenGui:Destroy()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Arowix69/X-Scripts-ish/master/prison-x%20v3.5%20experimental%20minimalist%20mode", true))()
